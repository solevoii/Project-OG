...
{
	public sealed class ExchangeResult : IMessage<ExchangeResult>, IMessage, IEquatable<ExchangeResult>, IDeepCloneable<ExchangeResult>
	{
		private static readonly MessageParser<ExchangeResult> _parser = new MessageParser<ExchangeResult>(() => new ExchangeResult());
		...
		[DebuggerNonUserCode]
		public static MessageParser<ExchangeResult> Parser
		{
			get
			{
				return _parser;
		...
		public static MessageDescriptor Descriptor
		{
			get
			{
				return InventoryMessageReflection.Descriptor.MessageTypes[4];
			}
		}
