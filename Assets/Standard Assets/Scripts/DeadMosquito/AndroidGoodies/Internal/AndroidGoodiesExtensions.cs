...
{
	internal static class AndroidGoodiesExtensions
	{
		public static string GetClassName(this AndroidJavaObject ajo)
		{
			return ajo.GetJavaClass().Call<string>("getName", Array.Empty<object>());
		}

		public static string GetClassSimpleName(this AndroidJavaObject ajo)
		{
			return ajo.GetJavaClass().Call<string>("getSimpleName", Array.Empty<object>());
		}
		...
		{
			return ajo.Call<string>("toString", Array.Empty<object>());
		}
